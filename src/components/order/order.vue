<template>
  <div>
    ...
    <el-card>
      ...
      <el-table :data="orderlist" border stripped>
        ...
        <el-table-column label="下单时间" prop="create_time|dateFormat">
          <template slot-scope="scope">{{scope.row.create_time|dateFormat}}</template>
        </el-table-column>
        <el-table-column label="操作" prop="user_id">
    ...
    <el-dialog title="修改地址" :visible.sync="addressVisiable" width="50%" @close="addDialogClosed">
      <el-form
        :model="addressForm"
